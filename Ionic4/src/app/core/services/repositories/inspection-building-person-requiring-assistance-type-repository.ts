...
import {
  InspectionBuildingPersonRequiringAssistanceForList
  } from 'src/app/shared/models/inspection-building-person-requiring-assistance-for-list';
...
export class InspectionBuildingPersonRequiringAssistanceTypeRepositoryProvider {
  ...
  private getForList(
    types: GenericType[],
    pnap: InspectionBuildingPersonRequiringAssistance): InspectionBuildingPersonRequiringAssistanceForList {
  ...
  private getCurrentItem(
    list: InspectionBuildingPersonRequiringAssistance[],
    modifiedItem: InspectionBuildingPersonRequiringAssistance): InspectionBuildingPersonRequiringAssistance {
