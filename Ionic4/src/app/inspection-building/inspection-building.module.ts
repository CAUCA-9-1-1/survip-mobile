...
import { BuildingParticularRiskDetailComponent } from './components/building-particular-risk-detail/building-particular-risk-detail.component';
...
@NgModule({
  declarations: [
    ...
    BuildingParticularRiskDetailComponent
  ],
  entryComponents: [
    BuildingContactDetailComponent,
    BuildingHazardousMaterialDetailComponent,
