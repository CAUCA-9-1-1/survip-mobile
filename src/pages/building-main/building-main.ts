...
export class BuildingMainPage {
  ...
  constructor(
    ...
    this.menuItems = [
      ...
      { title: this.labels['anomalities'], page:'BuildingAnomaliesPage', icon:'warning' },
    ];
  ...
  loadTranslation()
  {
      this.translateService.get([
          'buildingDetail', 'contacts', 'hazardousMaterial', 'pnaps','fireSafety', 'particularRisk', 'anomalities'
      ]).subscribe(labels => {
              this.labels = labels;
          },
          error => {
